...
Problem Statement: Write a Python program to convert an amount from Indian Rupees to
...
Enter the currency to convert from (dollar, pound, euro, yen): dollar
Enter the currency to convert to (dollar, pound, euro, yen): pound
100.0 dollar is equal to 81.72 pound.

output 2:
Enter the amount: 100
Enter the currency to convert from (dollar, pound, euro, yen): rupees
Enter the currency to convert to (dollar, pound, euro, yen): shiling
